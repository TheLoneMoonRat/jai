...
function analyzeFile(filePath, chunkTypeName) {
    ...
    for (let i = 0; i < data.length; i++) {
        ...
        // We'll calculate tokens by mapping the content of all messages in the chunk
        // and joining them (simulating how an AI would process the chunk)
...
analyzeFile('chunked_messages.json', '15-Minute Windows (Conversation)');
analyzeFile('chunked_messages_2hours.json', '2-Hour Windows');
analyzeFile('chunked_messages_daily.json', 'Daily Windows');
